---
name: wiki-sync
description: Refresh runtime skill artifacts from the formal skill-sync manifest. Use whenever llm_traders_wiki or mapped global Codex skills change.
---
