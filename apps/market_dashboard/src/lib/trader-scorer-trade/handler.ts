/**
 * trader-scorer-trade skill — local Next.js mirror.
 *
 * Canonical source: packages/core-skills/trader-scorer-trade/handler.ts
...
const PROMPT_TEMPLATE =
  ...
  "Using your knowledge of {ticker} around {trade_date_human}, infer the stock's sector, industry, " +
  "fundamental quality, recent catalysts, and technical structure at that time.\n\n" +
...
export const SYSTEM_PROMPT =
  "You are an expert trading coach reviewing trades using the SEPA scoring rubric.\n\n" +
  ...
  "Use your knowledge of the stock (sector, industry, fundamentals, recent catalysts, technical context at the trade date) " +
  "to make the review accurate.\n\n" +
...
export function buildPrompt(trade: TradePromptInput): string {
  ...
  const replacements: Record<string, string> = {
    ...
    trader_profiles_block: renderProfilesBlock(TRADER_PROFILES),
