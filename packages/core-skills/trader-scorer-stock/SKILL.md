...
- Medical/biotech risk status when relevant: commercial-product vs clinical-stage, binary event risk, sector-rotation vs company-specific catalyst, peer confirmation, and insider read
