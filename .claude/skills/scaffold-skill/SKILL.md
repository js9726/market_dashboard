...
```
<name>/
├── SKILL.md          ← frontmatter + when-to-use (for Claude.ai discovery)
...
## Reference
Plan: `C:\Users\jiesh\.claude\plans\locked-in-at-95-lexical-galaxy.md` § 4 (Skill Layout) and § 8 Phase 3.
